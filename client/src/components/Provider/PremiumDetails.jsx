        ...
        <div className="premiumdetails-content">
            ...
            >
              ...
              <div ref={reference} className="premiumdetails-buttons">
                {product.available_quantity < 1 && (
                  <p className="premiumdetails-nostock">Fuera de stock</p>
                )}
                <button
            ...
            <div className="pd-video-container">
              <div>
                <video autoPlay muted controls loop controlsList="nodownload">
                  <source
                    src="https://res.cloudinary.com/dsyjj0sch/video/upload/v1662173482/NAVE_Arcade_mp4.mp4"
                    type="video/mp4"
                  ></source>
                </video>
              </div>
          ...
          {React.Children.toArray(
            product.premiumData.extraText.map((e) => (
              ...
              >
                ...
                {e.img && (
                  <img src={e.img} alt="content img" style={e.imgPos} />
                )}
              </div>
            ))
          )}
          ...
          <div
            className={`premiumdetails-fixed ${
              isVisible ? "" : "premiumdetails-fixed-on"
            }`}
          >

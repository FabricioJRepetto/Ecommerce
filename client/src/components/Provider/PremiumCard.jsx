...
const PremiumCard = ({ productData, direction }) => {
  ...
  return (
    <div
      className={`premiumcard-container ${
    ...
    >
      <div
        className={`premiumcard-img-container${
          hover ? " premiumcard-img-hover" : ""
        }`}
      >
      ...
      <div
        className="premiumcard-lateral-container"
        style={{
          background: gradient,
          color: premiumData.textColor ? premiumData.textColor : "white",
        }}
      >

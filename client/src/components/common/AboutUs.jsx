...
const AboutUs = () => {
  ...
  return (
    <div className="about-container component-fadeIn">
      ...
      <div className="about-cards-container" style={{flexDirection: order ? 'column-reverse' : 'column'}}>

        <div className="about-card" style={{flexDirection: order ? 'row-reverse' : 'row', 
            borderRadius: order ? '0 7rem 7rem 0' : '7rem 0 0 7rem',
            background: `linear-gradient(${order ?'-90deg': '90deg'}, rgba(20,20,20,1) 29%, rgba(0,0,0,0) 100%)`}}>
        ...
        <div className="about-card" style={{flexDirection: order ? 'row' : 'row-reverse', 
